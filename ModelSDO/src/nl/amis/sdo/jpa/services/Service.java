...
public interface Service {
  ...
  @WebMethod(exclude=true) 
  public <S extends BaseDataObject<T>, T extends BaseEntity<S>> Long count(final Class<T> implementation, final FindCriteria findCriteria, final FindControl findControl) throws RuntimeException;
  @WebMethod(exclude=true) 
